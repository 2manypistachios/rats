module.exports = {
  ...
  siteDescription: 'The official website for the webcomic "Tale of the Serpent."', // Website description used for RSS feeds/meta description tag.
  siteRss: "/rss.xml", // Path to the RSS file.
  siteFBAppID: "1825356251115265", // FB Application ID for using app insights
  googleAnalyticsID: "UA-123878434-1", // GA tracking ID.
  disqusShortname: "parlourrats", // Disqus shortname.
  ...
  copyright: "Copyright © 2018. ParlourRats", // Copyright string for the footer of the website and RSS feed.
